...
const ProfilePage = () => {
    ...
    useEffect(() => {
        const getDetails = () => {
            axios.post('https://projectpulsecloned.onrender.com/StudentDetailByEmail',  { email: user.email } , {
    ...
    const handleEditDetails = async (e) => {
        ...
        axios.put(`https://projectpulsecloned.onrender.com/EditStudent/${StuData._id}`, formData, {
            headers: { // Use 'headers' instead of 'header'
            ...
            <div className='top-profile-container'>
                <div className='profile-image-container'>
                    <div className="profile-image-display">
                        ...
                        <img src={`https://projectpulsecloned.onrender.com/${StuImage}`} alt="Profile" className="profile-image" />
                    </div>
