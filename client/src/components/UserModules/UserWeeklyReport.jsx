...
const WeeklyReportForm = ({ project, fetchWeeklyReports }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://projectpulsecloned.onrender.com/AddWeeklyReportByStudent', formData, {
        headers: {
...
const UploadedReports = ({ project }) => {
  ...
  const fetchWeeklyReports = async () => {
    try {
      const response = await axios.get(`https://projectpulsecloned.onrender.com/ShowWeeklyReports/${project._id}`);
      ...
      {isModalOpen && (
        <div className="modal" onClick={closeModal}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <iframe 
              src={`https://projectpulsecloned.onrender.com/${modalFile}`} 
