...
const UploadedFiles = ({ project }) => {
  ...
  const fetchFiles = async () => {
    try {
      const response = await axios.get(`https://projectpulsecloned.onrender.com/ShowFilesToStudent/${project._id}`);
  ...
  const handleDownload = (fileUrl) => {
    ...
    link.href = `https://projectpulsecloned.onrender.com/${fileUrl}`;
    link.download = true;
    link.click();
  };

  const handleView = (fileUrl) => {
    setViewFileUrl(`https://projectpulsecloned.onrender.com/${fileUrl}`);
  };
...
const FileUploadForm = ({ project, fetchFiles }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`https://projectpulsecloned.onrender.com/AddProjectFilesByStudent`, formData, {
        headers: {
