...
const FacultyProfile = () => {
  ...
  useEffect(() => {
    const getDetails = () => {
      axios.get(`https://projectpulsecloned.onrender.com/FacultyDetailByEmail`, {
  ...
  const handleEditDetails = async (e) => {
    ...
    axios.put(`https://projectpulsecloned.onrender.com/EditFaculty/${FacutlyData._id}`, formData, {
      headers: {
      ...
      <div className='top-profile-container'>
        <div className='profile-image-container'>
          <div className="profile-image-display">
            ...
            <img src={`https://projectpulsecloned.onrender.com/${FacImage}`} alt="Profile" className="profile-image" />
          </div>
